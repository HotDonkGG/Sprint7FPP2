...
import main.model.exception.IntersectionsException;
import main.utility.UtilityManagers;
...
public abstract class TaskManagerTest <T extends TaskManager>{
    ...
    protected Task newTask(TaskType taskType) {
        switch (taskType) {
            case EPIC:
                return new Epic("Epic1", "Epic1", taskType);
            case SUBTASK:
                return new SubTask("Subtask1", "Subtask1", Instant.now(), Duration.ofMinutes(0), 1);
            default:
                return new Task("Task1", "Task1", Instant.now(), Duration.ofMinutes(0));
        }
    }
    ...
    public void updateEpicStateToInProgressTest() {
        ...
        var epic1 = manager.addEpic(newTask());
        var subtask1 = manager.addSubTask(newTask(epic1));
        var subtask2 = manager.addSubTask(newTask(epic1));
